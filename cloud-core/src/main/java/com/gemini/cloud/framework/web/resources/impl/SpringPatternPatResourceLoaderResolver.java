package com.gemini.cloud.framework.web.resources.impl;

import com.gemini.cloud.framework.web.resources.ResourceLoaderResolver;
...
public class SpringPatternPatResourceLoaderResolver implements ResourceLoaderResolver {
	...
	public SpringPatternPatResourceLoaderResolver() {
		...
		ConfigFilePath = "classpath*:cloud-*.yml";
	}
	...
	public ResourceLoaderResolver BuildResource() throws CloudCoreException {
		...
		try {
			...
			throw new CloudCoreException("扫描默认yml配置 error", e);
		}
